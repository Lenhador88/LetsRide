...
npm run test:unit                     # 1957/1957 across 64 files
...
PGPASSWORD=postgres npm test          # 1818 assertions, 0 failures
```
...
`postcards_region_location_is_rounded` is what makes that claim true against a client this app
...
ls supabase/migrations/ | wc -l          # 69
```
