...
PGPASSWORD=postgres npm test          # 1676 assertions, 0 failures
```
...
ls supabase/migrations/ | wc -l          # 74 — 074 is DEV-only, PROD is at 073
```
