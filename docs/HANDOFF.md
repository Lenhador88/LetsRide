...
PGPASSWORD=postgres npm test          # 1317 assertions, 0 failures
```
...
#   DEV 52 rows, ending 052_ride_map_render_ceiling_recursion · PROD 49, ending
#   049_search_places_token_cap. NOT level — 050/051/052 are DEV-only, and 050 needs
#   no PROD apply until the places load runs there (PD-195).
ls supabase/migrations/ | wc -l          # 52
```
