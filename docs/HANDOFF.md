...
PGPASSWORD=postgres npm test          # 2275 assertions, 0 failures
```
...
## Migrations — the repo holds 86, DEV is at `086` and PROD at `079`
...
ls supabase/migrations/ | wc -l          # 86 — DEV at 086, PROD at 079
```
