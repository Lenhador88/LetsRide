...
npm run test:unit                     # 1896/1896 across 63 files
...
PGPASSWORD=postgres npm test          # 1720 assertions, 0 failures
```
...
## Migrations — the repo and DEV hold 66, PROD holds 59
...
ls supabase/migrations/ | wc -l          # 66
```
