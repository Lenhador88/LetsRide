...
npm run test:unit                     # 1129/1129 across 42 files
...
PGPASSWORD=postgres npm test          # 1321 assertions, 0 failures
```
...
ls supabase/migrations/ | wc -l          # 53
```
