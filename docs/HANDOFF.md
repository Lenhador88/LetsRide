...
npm run test:unit                     # 2346/2346 across 74 files
...
PGPASSWORD=postgres npm test          # 2010 assertions, 0 failures
```
...
applied to DEV 2026-08-26; `081` (PD-307, club Discussions) on 2026-08-27. Both are **ADDITIVE**
...
`club_discussion_unread`, `moderate_club_discussion` and `delete_own_club_message`; code deployed
...
ls supabase/migrations/ | wc -l          # 81 — DEV at 081, PROD at 079
```
