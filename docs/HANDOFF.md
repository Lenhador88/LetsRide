...
npm run test:unit                     # 2419/2419 across 77 files
...
PGPASSWORD=postgres npm test          # 2144 assertions, 0 failures
```
...
## Migrations — the repo holds 84, DEV is at `084` and PROD at `079`
...
ls supabase/migrations/ | wc -l          # 84 — DEV at 084, PROD at 079
```
