...
PGPASSWORD=postgres npm test          # 1752 assertions, 0 failures
```
...
ls supabase/migrations/ | wc -l          # 77 — DEV is at 077, PROD at 075
```
