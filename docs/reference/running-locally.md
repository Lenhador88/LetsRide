...
Under `environment: 'node'`, all but **nine** render through `renderToStaticMarkup`, and jsdom is
...
because each of the nine below is there for a different one. Count them with
