...
├── components/
│   ├── ui/                 # AppBackground, Avatar, Banner, BoundaryError, Button, ButtonGroup, Card, Checkbox, ContextMenu, ErrorState, ExpandableText, FilterTile, FloatingAction, Input, ListUser, NotificationDot, NotificationRow, OfflineState, OptimisticToggle, Pagination, PlaceSearchField, ScrollSentinel, SectionHeader, Skeleton, Textarea
