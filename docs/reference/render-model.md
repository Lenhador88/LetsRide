...
`next build` reports **46 static** and **0 dynamic**, and no `ƒ Proxy (Middleware)` line appears
at all. Do not read the `Generating static pages (47/47)` line as the static route count — it is a
