...
| The pilot's recordings, already made | **Still in PostHog.** PD-456 stopped new ones on 2026-09-18 and un-collected nothing; retention is no longer the lever, because what exists is a finite set with an end date. `/legal/privacy` now tells riders they can ask for deletion | **Owner**, 7c-i |
