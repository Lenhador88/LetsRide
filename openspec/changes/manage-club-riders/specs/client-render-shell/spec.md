...
| Permission denied | `notFound()`, **not** an empty or read-only screen. A screen called *Manage riders* whose every control refuses is PD-125's unreachable screen arriving from the other side |
