...
// The template lives in lib.mjs so the staleness alarm can rebuild this file
// from the committed tokens.json with the generator's own code rather than a
// copy of it — see renderTokensTable's own comment.
await emit(
  'TOKENS.md',
  renderTokensTable({
    fileKey: FILE_KEY,
