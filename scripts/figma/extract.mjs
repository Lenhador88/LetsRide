...
// Reproduces the shape of the reference tables so drift is a plain `diff`.
// The pointer below names docs/reference/design-system.md, NOT CLAUDE.md: the
// tables moved there, and CLAUDE.md keeps only a signpost. It said CLAUDE.md
// until 2026-08-16, which made every `figma:extract` silently revert the
// corrected pointer in the generated file — a hand-edit cannot win against a
// generator, so the fix has to live here.
const table = [
