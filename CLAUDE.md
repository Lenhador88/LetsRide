...
halves of it are outstanding for the same reason — measured 2026-08-08.** DEV (`letsride-dev`) has
...
the count moved once. Compare label sets, never totals. (It read 527 for a few hours, from
